...
const Hero = () => {
  return (
    <div className='bg-[#F2F0F1]'>
        <div className='max-w-7xl overflow-hidden mx-auto px-5 py-10 grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-4'>
          {/* Hero Text  */}
          <div>
            ...
            <p className='my-5'>
               Browse through our range of meticulously crafted garments, 
               designed to bring out your individuality and cater to your sense of style
            </p>

            <Button className='max-md:w-full'> Shop Now </Button>

            <div className='mt-10 flex flex-wrap h-20'>
              <div>
